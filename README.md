...
Download [this](/docs/assets/sample-html-output.html) as html and open in a browser for a demo.

![DependenSee sample html output](/docs/assets/sample-output.png)
